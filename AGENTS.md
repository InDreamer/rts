...
3. [docs/confirmed/java-index-layer-full-plan-zh.md](/home/ubuntu/repos/rts/docs/confirmed/java-index-layer-full-plan-zh.md)

These three documents are the active development baseline.
