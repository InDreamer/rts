...
- [docs/company-computer-kb-workflow-checklist-zh.md](docs/company-computer-kb-workflow-checklist-zh.md)
  Use after copying RTS to a company computer to run the source inventory -> claims -> KB draft -> source-backed review -> blocker questions workflow against restricted corporate source assets.
- [docs/company-source-to-kb-mvp-runbook-zh.md](docs/company-source-to-kb-mvp-runbook-zh.md)
  Use for the company-executable source-backed KB draft MVP runbook, including inputs, execution order, artifact directories, success/failure standards, and completion report.
